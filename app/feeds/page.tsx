      ...
      <div className="mx-auto max-w-4xl">
        <div className="mb-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <h1 className="text-4xl font-bold font-serif flex items-center gap-3 text-balance">
                  ...
                  <CardContent className="p-0">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <h2 className="text-lg font-bold group-hover:text-primary transition-colors truncate font-sans">
                          {post.title}
                        </h2>
