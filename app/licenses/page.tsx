...
const licenses: LicenseItem[] = [
  ...
  { id: "203", name: "Favicon", license: "Proprietary", source: "Custom Design", url: "#", category: "Assets", icon: ImageIcon },
]
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container relative z-10 mx-auto px-6 pb-12">
          ...
          >
            ...
            <p className="max-w-xl text-muted-foreground text-base google-sans font-light">
              Transparently documenting the open-source software, typography, and assets that power this workspace.
            </p>
          </motion.div>
        </div>
      ...
      <div className="mx-auto max-w-6xl px-6 py-12">
          ...
          <div className="relative z-10 flex flex-col md:flex-row gap-6 items-center">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-muted-foreground google-sans leading-relaxed text-sm md:text-base">
                This website is open-source software under the <strong className="text-foreground">GNU Affero General Public License v3.0</strong>.
              </p>
            </div>
            <SafeLink
              ...
              >
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <ExternalLink size={12} className="text-muted-foreground/40 group-hover:text-primary/60 transition-colors" />
                  </div>
        ...
        <section className="mt-20 pt-10 border-t border-border/40 text-center">
          <h2 className="text-2xl font-bold philosopher mb-4">Acknowledgments</h2>
