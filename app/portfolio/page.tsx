        ...
        <div className="min-h-screen bg-background">
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="flex flex-col items-center gap-12 lg:flex-row lg:items-start">
                        ...
                        <div className="text-center lg:text-left">
                            ...
                            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-muted-foreground font-font-sans">
            ...
            <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
                ...
                <section className="mb-24">
                    <div className="mb-12 flex flex-col items-center text-center">
                        <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-primary/10 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-primary font-font-mono">
                            <Dna className="h-4 w-4" />
                            Competency Framework
                        </div>
                        <h2 className="text-3xl font-bold font-serif sm:text-4xl">Technical Expertise Matrix</h2>
                        <p className="mt-4 max-w-2xl text-muted-foreground font-font-sans">
                    ...
                    <div className="lg:col-span-2 space-y-16">
                        ...
                        <section>
                            <div className="mb-8 flex items-center gap-3 border-b border-border pb-4">
                                ...
                                <h2 className="text-2xl font-bold font-serif">Featured Engineering Projects</h2>
                            </div>
                            <div className="grid gap-6 sm:grid-cols-2 font-font-sans">
                        ...
                        <section>
                            <div className="mb-8 flex items-center gap-3 border-b border-border pb-4">
                                ...
                                <h2 className="text-2xl font-bold font-serif">Professional Milestones</h2>
                            </div>
                            <div className="space-y-8 font-font-sans">
                    ...
                    <div className="space-y-12">
                        ...
                        <section className="rounded-2xl border border-border bg-card p-8 shadow-sm">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h3 className="text-xl font-bold font-font-serif">Education</h3>
                            </div>
                            <div className="space-y-6 text-sm font-font-sans">
                                <div>
                        ...
                        {/* Research Interests */}
                        <section className="rounded-2xl border border-border bg-card p-8 shadow-sm">
                            <h3 className="text-xl font-bold mb-4 font-font-serif">Research Interests</h3>
                            <div className="space-y-3 font-font-sans">
                                {[
                        ...
                        {/* Languages */}
                        <section className="rounded-2xl border border-border bg-card p-8 shadow-sm">
                            <h3 className="text-xl font-bold mb-4 font-font-serif">Languages</h3>
                            <div className="flex flex-wrap gap-2 text-xs font-font-sans">
            ...
            <section className="bg-primary/5 py-16 text-center border-t border-border">
                <div className="mx-auto max-w-2xl px-6">
                    <h2 className="text-3xl font-bold font-serif mb-4">Let&apos;s Build Something Together</h2>
                    <p className="text-muted-foreground font-font-sans mb-8 leading-relaxed">
                        I am always open to discussing new projects, creative ideas or
                        opportunities to be part of your visions.
                    </p>
                    <Button size="lg" className="font-font-mono rounded-full px-12 transition-transform hover:scale-105">
                        Get In Touch
                    </Button>
                </div>
            </section>
