      ...
      <section className="relative border-b border-border h-[40vh] min-h-[300px]">
        ...
        <div className="relative z-10 flex h-full items-center justify-center px-6 text-center">
          <div className="max-w-3xl text-white">
            <h1 className="text-4xl font-bold tracking-tight lg:text-5xl font-serif">Privacy Policy</h1>
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-foreground mb-1 font-sans">100% Client-Side</h4>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-foreground mb-1 font-sans">0% External Sharing</h4>
            ...
            <div className="md:col-span-2 min-h-[300px] flex flex-col items-center justify-center p-8 rounded-2xl border-2 border-dashed border-border bg-muted/30">
              {selectedCookie ? (
                <div className="w-full animate-in fade-in slide-in-from-bottom-2 duration-300">
                  ...
                  <div className="space-y-6">
                    <section>
                      <h5 className="text-sm font-bold text-foreground mb-2 font-sans">Purpose of Collection</h5>
                      <p className="text-muted-foreground text-sm leading-relaxed">{cookieData[selectedCookie].purpose}</p>
                    </section>
                    <section>
                      <h5 className="text-sm font-bold text-foreground mb-2 font-sans">User Impact</h5>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={item.id} className="rounded-2xl border border-border overflow-hidden">
                ...
                >
                  <span className="font-bold text-foreground font-sans">{item.title}</span>
