  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-40 lg:hidden h-14 overflow-hidden border-b border-border/40">
      ...
      <div className="relative h-full flex items-center justify-center px-4">
        ...
        >
          <motion.span
            ...
            className="text-sm font-black tracking-[0.4rem] uppercase mozilla-headline bg-linear-to-r from-primary via-secondary to-primary bg-[length:200%_auto] bg-clip-text text-transparent"
          >
            PrasadM
          </motion.span>
      ...
      <motion.div
        ...
        className="absolute bottom-0 left-0 w-1/3 h-[1px] bg-linear-to-r from-transparent via-primary/40 to-transparent"
      />
    </div>
  );
}
