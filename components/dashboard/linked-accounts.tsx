...
const PROVIDERS = [
  ...
  },
  {
    ...
    name: "GitHub",
    icon: SiGithub,
    color: "hover:bg-zinc-500/10 hover:text-zinc-500",
  },
  {
    id: "facebook",
    name: "Facebook",
  ...
  },
  {
    ...
    name: "Notion",
    icon: SiNotion,
    color: "hover:bg-zinc-800/10 hover:text-zinc-800",
  },
  {
    id: "vercel",
    name: "Vercel",
    icon: SiVercel,
    color: "hover:bg-zinc-900/10 hover:text-zinc-900",
  },
];
      ...
      <CardContent className="space-y-4">
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="font-medium font-google-sans">
                  {provider.name}
                </span>
              </div>
        ...
        {accounts.length === 1 && (
          <div className="flex items-start gap-2 p-3 mt-4 text-xs text-amber-500 bg-amber-500/10 rounded-lg border border-amber-500/20">
            ...
            <p>
              You only have one account linked. Connect another provider to
              enable disconnecting this one.
            </p>
          </div>
        )}
      </CardContent>
