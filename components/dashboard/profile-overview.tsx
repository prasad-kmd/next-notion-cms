        ...
        <div className="flex flex-col md:flex-row items-start gap-6 text-left">
          ...
          <div className="flex-1 space-y-4">
            <div className="space-y-1">
              <h2 className="text-2xl font-bold google-sans tracking-tight text-foreground">
                {user.name}
              </h2>
            ...
            <div className="flex flex-wrap items-center justify-start gap-3">
              <Badge
                variant="secondary"
                className="bg-primary/5 text-primary border-primary/20 px-2.5 py-0.5 text-[10px] uppercase tracking-wider font-bold"
              >
                Active Account
              </Badge>
