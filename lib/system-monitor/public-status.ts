...
export function getPublicOverallStatus(
  notionStatus: SystemStatus,
  supabaseStatus: SystemStatus,
) {
...
export function getPublicServices(
  ...
  return [
    ...
    },
    {
      name: "Comments",
      status:
        notionStatus === "operational" && supabaseStatus === "operational"
          ? "operational"
          : notionStatus === "error" || supabaseStatus === "error"
            ? "error"
            : "degraded",
