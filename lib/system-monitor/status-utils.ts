...
export function determineStatus(latency: number, hasError: boolean, rateLimitPercent?: number): SystemStatus {
    ...
    if (rateLimitPercent !== undefined && rateLimitPercent > 80) return 'degraded';
